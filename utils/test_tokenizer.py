...
def process_func(
    prompt_txt: str, user_text: str, assistant_txt: str, max_length = 512
):
    input_ids, labels = [], []
    prompt = [tokenizer.get_command("<|system|>")] + tokenizer.encode(
                prompt_txt + "\n", 
...
if __name__ == '__main__':
    ...
    messages = [
        {"role": "system", "content": "你是由 wanggroup 开发的个人助手。"},
