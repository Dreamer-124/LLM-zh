...
st.set_page_config(page_title = "LLM 1480M Demo")
st.title("Tiny LLM 1480M Demo")

# model_id = "outputs/ckpt/llm_sft_1480m"
model_id = "wanggroup/llm_sft_1480m"
...
def init_chat_messages():
    with st.chat_message("assistant", avatar = '🤖'):
        st.markdown("您好，我是由 wanggroup 开发的个人助手，很高兴为您服务😄")
...
def main():
    ...
    if prompt := st.chat_input("Shift + Enter 换行, Enter 发送"):
        ...
        with st.chat_message("assistant", avatar='🤖'):
            ...
            generated_ids = model(
                model_inputs.input_ids, generation_config = generation_config
            )
            generated_ids = [
