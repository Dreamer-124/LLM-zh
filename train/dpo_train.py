...
from llm_dataset import load_dpo_dataset
...
if __name__ == '__main__':
    ...
    dpo_dataset = load_dpo_dataset(
        script_args.dataset_dir_or_path, max_length = script_args.max_length, sanity_check = script_args.sanity_check
    )
    ...
    if script_args.eval_dataset_dir_or_path == "":
        ...
        eval_dataset = load_dpo_dataset(
            script_args.eval_dataset_dir_or_path, max_length = script_args.max_length, sanity_check = script_args.sanity_check
        )
    ...
    dpo_trainer = DPOTrainer(
        ...
        max_length = scritpt_args.max_length
